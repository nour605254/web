...
<title>Ouerghemmi Optique | gérer  clients</title>
        ...
        <link href="css/seConnecte.css" rel="stylesheet" type="text/css" />
    ...
    <h1 class="login">Se connecter</h1>
                              <br><table>
                                  <tr>
                                          ...
                                          <td><input class="inp" type="email"  name="email" value=""  placeholder="exemple@example.com" required placeholder="" ></td>
                                 </tr>
                                          <tr>
                                          <td><label for="fname">Mot de passe</label></td>
                                          <td><input class="inp" type="password" name="pwd" value="" required placeholder=""></td>
                                          </tr>
                                 </table>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col">
                                    <a href="http://localhost/git/web/views/backoffice/pages/nour/creer_compte.php" style="color:white" class="btn">Créer un compte</a>
                                  </div>
