                    ...
                    <div class="col-12 col-md-6">
                          <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <div class="cart-page-heading">
                                <h5> ajouter livraison </h5>

                                
                            </div>
<form name="f" method="POST" action="ajoutlivraison.php" >
                           
                                    
                                    <div class="col-12 mb-3">
                                        <label for="company"> id </label>
                                        <input type="text" class="form-control" name="id_liv" required="">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label for="street_address">Address <span>*</span></label>
                                        <input type="text" class="form-control mb-3" name="adresse_liv"required="">
                                        
                                    </div>
                                     
                                    <div class="col-12 mb-3">
                                        <label for="country">region <span>*</span></label>
                                        <select class="custom-select d-block w-100" name="region_liv"required="">
                                        <option> tunis </option>
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <input type="email" value="<?php echo $_SESSION['user_email'] ; ?>" class="form-control" id="email_address" >
                                    </div>
                                   
                                     <div class="col-12 mb-3">
                                        <label for="street_address">date <span>*</span></label>
                                        <input type="date" class="form-control mb-3" name="date_liv"required="">
                                                                            <input type="submit" name="ajouter" value="ajouter" class="btn karl-checkout-btn">s 
