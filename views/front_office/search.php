...
$listeproduits=$produit1C->recherche($search_value);
                            ...
                            <div class="row" id="myList">
                                ...
                                <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig" data-wow-delay="0.2s" >
                                    ...
                                    <div class="product-img">
                                        <img src="../../../tryyyy/views/back office/pages/wifek/productimg/  <?= $row->image; ?>" alt="">
                                    ...
                                    <div class="product-description" >
                                        ...
                                        <prix class="product-price"><?= $row->prix; ?> DT</prix>
                                        <p ><?= $row->type_produit; ?> </p>
                                        <!-- Add to Cart -->
