                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_footer_area">
                            ...
                            <div class="subscribtion_form">
                                ...
                                {
                                ?>
                                <h3 style="color: red"> vous êtes déja inscrit !!</h3>
                                <?php
                                }  
                                if(isset($_SESSION['user_email']))
                                {
                                 ?>
                                <input hidden="true" type="email" name="mail" class="mail" value="<?php echo $_SESSION['user_email'] ?>" placeholder="Votre Mail Ici">
                                <h3 style="color: green">vous êtes connectées</h3>
                                <?php  }else{ ?>
