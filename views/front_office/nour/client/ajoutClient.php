...
<body>
                    ...
                    <div class="row h-100 align-items-center justify-content-end">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                <!-- Logo Area -->
                                <div class="top_logo">
                                    <a  href="http://localhost/tryyyy/views/front_office/nour/client/authentification/se_connecter.php" ><img src="img/core-img/logo.png" alt=""></a>
                                </div>
                                <!-- Cart & Menu Area -->
 ...
 <section>
<form method="POST" action="http://localhost/tryyyy/views/front_office/nour/client/authentification/ajoutClient.php">
            <div class="container">
      <div class="row">
