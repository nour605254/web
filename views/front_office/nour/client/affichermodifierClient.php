...
<?PHP
include "C:/wamp64/tryyyy/web/entities/nour/client/client.php";
include "C:/wamp64/tryyyy/web/core/nour/client/ClientCore.php";
//include "../../config.php";
if (isset($_GET['id'])){
...
if (isset($_POST['modifier'])){
    ...
    header('Location: ../adresse/ajoutAdresse.php');
}
?>
        </section>
