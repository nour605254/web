                                      ...
                                      <div class="cart">
                                        ...
                                        <ul class="cart-list">
                                            ...
                                            else
                                            {
                                                ...
                                                <li>
                                                <a href="#" class="image"><img src="img/product-img/a1.jpg" class="cart-thumb" alt=""></a>
                                    ...
                                    <div class="menu-list">
                                        <ul id="menu-content2" class="menu-content collapse out">
                                            ...
                                            <li data-toggle="collapse" data-target="#women2">
                                                <a href="Recherchercategorie.php">Collection Lunettes</a>
                                                <ul class="sub-menu collapse show" id="women2">
                                                    <li><a href="#" onclick="Recherchercategorie.php">Optic</a></li>
                                                    <li><a href="#">Solaires</a></li>
                                                </ul>
                                            </li>
                                            <!-- Single Item -->
                                            <li data-toggle="collapse" data-target="#man2" >
                                                <a href="#">Collection Lentilles</a>
...
$listeproduits=$produit1C->selectsolaire();
