                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                ...
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    <!-- Cart Area -->
                                    <div class="cart">
                                        <a  href="http://localhost/tryyyy/views/front_office/nour/client/authentification/se_connecter.php" id="header_connect" ><t/><i class="ti_connect"></i> Connexion</a>
                                     </div>
                                    <div class="cart">
                                        ...
                                        <ul class="navbar-nav animated" id="nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="karlDropdown">
                                                    ...
                                                    <a class="dropdown-item" href="product-details.html">Détails Produits</a>
 ...
 <br/> <center> <h1>Client</h1></center><br/>
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="row">Désactiver</th>
      <th scope="row">Modifier</th>
      <th scope="row">Imprimer</th>
      <th scope="row">Envoie mail</th>
...
foreach($listeClients as $row){
    ...
    <th><form method="POST" action="nour/client/supprimerClient.php">
    <center><input class="btn btn-danger" type="submit" name="supprimer" value="Désactiver" ></center>
    <input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">
    </form>
    </th>
    <th><a class="btn btn-success" href="nour/client/modifierClient.php?id=<?PHP echo $row['id']; ?>">
    Modifier</a></th>
    <th><a class="btn btn-success" href="nour/client/impression.php?id=<?PHP echo $row['id']; ?>">
    Imprimer</a></th>
    <th scope="row">
      <?php
...
mail("nour.affes@esprit.tn", "Vous avez été notifié", $message, $header);
}
?>
<form method="POST" action="">
  <input class="btn btn-success"  type="submit" value="envoyer mail" name="mailform"/>
</form>
</th>
