...
if (isset($_GET['numC'])){
    ...
    $result=$commandeC->recuperercommande($_GET['numC']);
...
?>
<form method="POST" action="mail.php?numC=<?php echo $_GET['numC']; ?>">
...
<td><input type="text" disabled value="<?PHP echo $etatC ?>">
<select type="text" name="etatC"  >
...
<input type="hidden" name="numC_ini" value="<?PHP echo $_GET['numC'];?>"></td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
