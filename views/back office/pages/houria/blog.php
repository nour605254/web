                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <img id="myBtn" style="width: 2%;height: 2%;" src="plus.png">
                                    <a href="statistique.php"><img style="width: 10%;height: 10%;" src="stat.jpg"></a> 
                                    <!-- Trigger/Open The Modal -->
                                     <div class="box-body table-responsive">
    <?PHP
include "../../../../core/blogC.php";
$blog1C=new blogC();
$listeblog=$blog1C->afficherblog();
?>
...
foreach($listeblog as $row){
    ?>
    <tr>
    <td><?PHP echo $row['numBlog']; ?></td>
    <td><?PHP echo $row['titreBlog']; ?></td>
    <td><?PHP echo $row['description']; ?></td>

    <td><img src="<?PHP echo $row['imageBlog']; ?>" width="50px" ></td>
    <td><?PHP echo $row['marque']; ?></td>
    <td><form method="POST" action="supprimerblog.php">
    <input type="image" src="sup.png" class="consult" width="20" height="20">
    <input type="hidden" value="<?PHP echo $row['numBlog']; ?>" name="numBlog">
    </form>
    <a href="modifierblog.php?numBlog=<?PHP echo $row['numBlog']; ?>">
...
?> </td>
                            ...
                            <div id="myModal" class="modal">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form method="POST" action="ajoutBlog.php" name="f1">
...
<td><input type="text" name="titreBlog" required></td>
<td><textarea name="description" required></textarea></td>
<td><input type="file" name="imageBlog" required></td>
