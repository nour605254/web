...
<html>
    ...
    <head>
        ...
        <!-- font Awesome -->
        <link href="../../cssfont-awesome.min.css" rel="stylesheet" type="text/css" />
        <!-- Ionicons -->
        ...
        <link rel="stylesheet" type="text/css" href="../../pages/houria/hou.css">
...
if (isset($_GET['numBlog'])){
    $blogC=new blogC();
    $result=$blogC->recupererblog($_GET['numBlog']);
    foreach($result as $row){
        $numBlog=$row['numBlog'];
        $titreBlog=$row['titreBlog'];
        $description=$row['description'];
        $imageBlog=$row['imageBlog'];
...
<form method="POST" name="f">
     <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
<td><input type="number"  name="numBlog" value="<?PHP echo $numBlog ?>" required ></td>

<td><input type="text" name="titreBlog" value="<?PHP echo $titreBlog ?>"required ></td>

<td><input type="textarea" name="description" value="<?PHP echo $description ?> " required></td>
   <td> <select type="text" name="marque" required >
    <option value="carrera">carrera</option>
    <option value="retro eyewear">retro eyewear</option>
    
    <option value="ray ban">ray ban</option>
</select> </td>


<td><input type="file" name="imageBlog" value="<?PHP echo $imageBlog ?>" required></td>

<td><input type="submit" name="modifier" value="modifier" onclick="verif()" required>
<input type="hidden" name="numBlog_ini" value="<?PHP echo $_GET['numBlog'];?>" ></td>
...
if (isset($_POST['modifier'])){
    $blog=new blog($_POST['titreBlog'],$_POST['description'],$_POST['imageBlog'],$_POST['marque']);
    $blogC->modifierblog($blog,$_POST['numBlog_ini']);
    echo $_POST['numBlog_ini'];
...
?>
        ...
        <script type="text/javascript" src="../../pages/houria/commande.js"></script>
