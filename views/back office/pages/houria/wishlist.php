...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Ouerghemmi Optique | gérer wishlist</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Les wish-list des clients </h3>                                    
                                </div><!--box-header -->
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="icon.png" class="consult">
                                                   <img src="sup.png" class="consult">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Chercher wish list</h3>                                    
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> 
                                                    <img src="icon.png" class="consult">
                                                   <img src="sup.png" class="consult"></td>
                                            </tr>
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Modifier wish list</h3>                                    
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Id client</th>
                                                <th>les produits de wish-list</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input type="number" name="num_commande" id="num_commande" /> <img src="actualiser.png" class="consult"></td>
                                                <td>Win 95+</td>
                                                <td> 
                                                    <img src="valider.jpg" class="consult">
                                                   <img src="sup.png" class="consult"></td>
                                            </tr>
