                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <i class="fa fa-warning danger"></i> Very long adresseC here that may not fit into the page and may cause design problems
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <input id="myInput" type="text" placeholder="Chercher..">
<br>
                                    <h3 class="box-title">Les commandes</h3>  
                                    
                                    <br><br><a href="trier.php"> trier selon total</a>
...
?> 
                                    ...
                                    <table id="myUL" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>num commandes</th>
                                                <th>id client</th>
...
foreach($listeCommande as $row){
    ...
    <input type="image" src="sup.png" class="consult" width="20" height="20">
    <input type="hidden" value="<?PHP echo $row['numC']; ?>" name="numC">
    </form>
    <a href="modifierCommande.php?numC=<?PHP echo $row['numC']; ?>">
    
    <input type="image" src="icon.png"  width="20" height="20"></a>
    <form method="POST" action="details.php?numC=<?PHP echo $row['numC']; ?>">
    <input type="image" src="show.png" class="consult" width="20" height="20">
    <input type="hidden" value="<?PHP echo $row['numC']; ?>" name="numC">
    </form>
    <?PHP
}
?> </td>
                                    ...
                                    <form action="imprimercommande.php" method="POST">
                                    <button a>imprimer les commande</button></form>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
