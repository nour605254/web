...
<!-- ajouter -->
                                ...
                                <div id="myModal" class="modal">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form name="form1" method="POST" action="ajoutlivraison.php">
                                    <table>
                                          <tr>
                                          ...
                                          <tr>
                                                ...
                                                <td>
                                                        <input type="text" placeholder="id" class="id" name="id_liv">
                                                </td>
                                                <td>
                                                        <input type="text" placeholder="adresse" name="adresse_liv">
                                                </td>
                                                
                                                <td>
                                                    
                                                    <div class="custom-select" >
                                                      <select name="region_liv">
                                                ...
                                                <td>
                                                        <input type="date" placeholder="date livraison" name="date_liv">
                                                </td>
