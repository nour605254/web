                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Les livreurs</h3> 
           ...
           <input type="submit" class="float-right"  value="search">
                                    ...
                                    <form  action="statistique.php">
                                        <table>
                                         ...
                                         <button><img src="st.png" class="consult"></button></a>
...
$livreur1=new livreurC();
$listelivreur=$livreur1->afficherlivreurs();
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>email </th>
                                                <th>action <button id="myBtn"><img src="plus.png" class="consult"></button></th>
                                            </tr>
                                        </thead>
                                        <tbody>
...
foreach($listelivreur as $row){
    ?>
                                            <tr>
                                                ...
                                                <td><?PHP echo $row['nom_livr']; ?></td>
                                                <td><?PHP echo $row['prenom_livr']; ?></td>
                                                <td><?PHP echo $row['nb_livr']; ?></td>
                                                 <td><?PHP echo $row['email']; ?></td>
                                                <td>
                                                    <a href="modifierlivr.php?id_livr=<?PHP echo $row['id_livr']; ?>"> 
    ...
    <input type="hidden" value="<?PHP echo $row['id_livr']; ?>" name="id_livr">
    </form>
    <form method="POST" action="mail.php">
                                                        <input type="email" placeholder=" email" name="email">
                                                        <button><img src="i.png" class="consult"></button></a>
                                                    </form>
...
<!-- ajouter -->
                                ...
                                <div id="myModal" class="modal">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form  method="POST" action="ajoutlivreur.php" name ="f">
                                    <table>
                                          <tr>
                                          ...
                                          <tr>
                                                ...
                                                <td>
                                                        <input type="number" placeholder="id" class="id" name="id_livr">
                                                </td>
                                                <td>
                                                        <input type="text" placeholder="nom_livr" name="nom_livr">
                                                </td>
                                                   <td>
                                                        <input type="text" placeholder="prenom_livr" name="prenom_livr">
                                                </td>
                                                
                                                <td>
                                                        <input type="number" placeholder=" nb_livr" name="nb_livr">
                                                </td>
                                                 <td>
                                                        <input type="email" placeholder=" email" name="email">
                                                </td>
                                    ...
                                    <br>
                                    <button onclick="test()"  name="ajouter" class="add"> Ajouter </button>
                                    <br>
                                      </form>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
         ...
         <script type="text/javascript" src="livcontrol.js"></script>
<script src="controle.js " type="text/javascript"></script>
