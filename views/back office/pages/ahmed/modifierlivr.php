            ...
            <aside class="left-side sidebar-offcanvas">                
                ...
                <section class="sidebar">
                    ...
                    <li>
                     ...
                     <li class="treeview">
                            <a href="promotion1.php">
                                <i class="fa fa-bar-chart-o"></i>
                                <span>promotion</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                           <li><a href="promotion1.php"><i class="fa fa-angle-double-right"></i> liste promotion</a></li>

                                <li><a href="gerer.html"><i class="fa fa-angle-double-right"></i> ajouter promotions</a></li>
...
if (isset($_GET['id_livr'])){
    $livC=new livreurC();
    $result=$livC->recupererlivreur($_GET['id_livr']);
    foreach($result as $row){
        $id_livr=$row['id_livr'];
        $nom_livr=$row['nom_livr'];
        $prenom_livr=$row['prenom_livr'];
        $nb_livr=$row['nb_livr'];
        $email=$row['email'];
...
<form  method="POST" action="modifierrlivr.php">
<table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><input type="number" name="id_livr" placeholder="#1254 * " value="<?PHP echo $id_livr ?>"></td>
                                                <td><input type="text" name="nom_livr" placeholder="Black friday*" value="<?PHP echo $nom_livr ?>" ></td>
                                                <td><input type="text" name="prenom_livr" placeholder="15 %" value="<?PHP echo $prenom_livr ?>" ></td>
                                                <td><input type="number" name="nb_livr" placeholder="" value="<?PHP echo $nb_livr ?>"></td>
                                                <td><input type="email" name="email" placeholder="" value="<?PHP echo $email ?>"></td>
