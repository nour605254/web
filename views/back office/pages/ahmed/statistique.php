...
{
 $chart_data .= "{ prenom_livr:'".$row["prenom_livr"]."', nb_livr:".$row["nb_livr"]."}, ";
}
...
<html>
 ...
 <body>
  ...
  <div class="container" style="width:900px;">
   ...
   <h3 align="center">statistique de nombre de livraison de chaque livreur selon leurs ID </h3>   
   <br /><br />
   <div id="chart"></div>
  </div>
 </body>
...
Morris.Bar({
 ...
 xkey:'prenom_livr',
 ykeys:['profit', 'nb_livr'],
 labels:['prenom_livr', 'nb_livr' ],
 hideHover:'auto',
 stacked:true
});
</script>
