...
if (isset($_GET['id_liv'])){
    $livC=new livraisonC();
    $result=$livC->recupererlivraison($_GET['id_liv']);
    foreach($result as $row){
        $id_liv=$row['id_liv'];
        $adresse_liv=$row['adresse_liv'];
        $region_liv=$row['region_liv'];
...
<table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><input type="text" name="id_liv" placeholder="#1254 * " value="<?PHP echo $id_liv ?>"></td>
                                                <td><input type="text" name="adresse_liv" placeholder="Black friday*" value="<?PHP echo $adresse_liv ?>" ></td>
                                                <td><input type="text" name="region_liv" placeholder="15 %" value="<?PHP echo $region_liv ?>" ></td>
                                                <td><input type="date" name="date_liv" placeholder="" value="<?PHP echo $date_liv ?>"></td>
