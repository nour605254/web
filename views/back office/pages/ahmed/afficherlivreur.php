...
<!-- ajouter -->
                                ...
                                <div id="myModal" class="modal">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form name="form1" method="POST" action="ajoutlivreur.php">
                                    <table>
                                          <tr>
                                          ...
                                          <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <td>
                                                        <input type="date" placeholder="prenom_livr" name="prenom_livr">
                                                </td>
                                                
                                                <td>
                                                        <input type="date" placeholder=" nb_livr" name="nb_livr">
                                                </td>
                                                <td>
                                    ...
                                    <br>
                                    <button onclick="control()"  name="ajouter" class="add"> Ajouter </button>
                                    <br>
                                      </form>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
