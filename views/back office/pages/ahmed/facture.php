                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Les factures en cours</h3>                                    
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <?PHP
include "../../../../core/factureC.php";
$facture1=new factureC();
$listefacture=$facture1->afficherfactures();
...
?>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                          ...
                                          <?PHP
foreach($listefacture as $row){
    ?>
                                            <tr>
                                                <td><?PHP echo $row['id_fac']; ?></td>
                                                <td><?PHP echo $row['prix_fac']; ?></td>
                                                <td><?PHP echo $row['date_fac']; ?></td>
