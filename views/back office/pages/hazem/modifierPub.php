...
if (isset($_GET['id_pub'])){
    ...
    $result=$pub1C->recupererPub($_GET['id_pub']);
    foreach($result as $row){
        $id_pub=$row['id_pub'];
        $titre_pub=$row['titre_pub'];
        $image=$row['image'];
        $date_d_pub=$row['date_d_pub'];
        $date_f_pub=$row['date_f_pub'];
        $desc_pub=$row['desc_pub'];
?>
<span class="close">&times;</span>
                                <form name="form1" method="POST" action="modifierPubb.php?id=<?PHP echo $id_pub ?>">
                                        <table>
                                          <tr>
                                          ...
                                          <tr>
                                                ...
                                                <th>
                                                        <input type="text"  name="titre" value="<?PHP echo $titre_pub ?>">
                                                </th>
                                                <th>
                                                        <input type="file"  name="image" value="<?PHP echo $image ?>">
                                                </th>
                                                <th>
                                                        <input type="Date"  name="dated" value="<?PHP echo $date_d_pub ?>">
                                                </th>
                                                <th>
                                                        <input type="Date"  name="datef" value="<?PHP echo $date_f_pub ?>">
                                                </th>
...
<table>
                                          <tr>
                                              ...
                                              <input type="textarea" id="apropos" style="height:90px;width: 100%;margin-bottom: 3%;" name="desc" value="<?PHP echo $desc_pub ?>">      
...
<script src="controlee.js" type="text/javascript"></script>
      <!-- jQuery 2.0.2 -->
