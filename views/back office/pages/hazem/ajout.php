                ...
                <section class="content">
                  ...
                  <!-- Modal content -->
                    ...
                    <h2>Ajouter Publicité</h2>
                                    <form  name="form1" method="POST" action="ajoutPub.php">
                                        <table>
                                          <tr>
                                          ...
                                          <tr>
                                                ...
                                                <td>
                                                        <input type="text" placeholder="Titre de publicité" name="titre_pub">
                                                </td>
                                                <td>
                                                        <input type="file"  name="image">
                                                </td>
                                                <td>
                                                        <input type="Date"  name="date_d_pub">
                                                </td>
                                                <td>
                                                        <input type="Date"  name="date_f_pub">
                                                </td>
...
<table style="background-color: #f2f2f2">
                                          <tr >
                                                    ...
                                                    <textarea id="apropos" style="height:90px;width: 100%;margin-bottom: 3%;" name="desc_pub" placeholder="ecrire une descrition à votre publicité  (50 caractéres)"></textarea>
