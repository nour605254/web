                    ...
                    <div class="row">
                        ...
                        <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Les publicités </h3> 
...
?>
                                    	...
                                    	<table>
                                            <tr>
                                            <td>    
                                        <form  action="statistiquee.php"><button  style="width: 70%" type="submit" name="like" class="add" data-animation="fadeInUp" data-delay="1s" data-duration="500ms" >statistique</button></form></td>
                                        <td>
                                            <form  action="trier.php"><button   type="submit" name="like" class="add" data-animation="fadeInUp" data-delay="1s" data-duration="500ms" >trier</button></form></td>
                                        </tr>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Nombre de vue</th>
                                                <th>Description</th>
                                                <th>action / L'Ajout de pub <a href="ajout.php"><img   src="plus.png" class="consult"></a></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                          ...
                                          <?PHP
                                            ...
                                            ?>
                                            <?PHP
                                            foreach($listetrier as $row){
                                            ?>
                                            <tr>
                                                <td><?PHP echo $row['id_pub']; ?></td>
                                                <td><?PHP echo $row['titre_pub']; ?></td>
                                                <td style="width: 20%"><img style="width: 20%; height: 10%;" src="<?PHP echo $row['image']; ?>" ></td>
                                                <td><?PHP echo $row['date_d_pub']; ?> </td>
                                                <td><?PHP echo $row['date_f_pub']; ?></td>
                                                <td><?PHP echo $row['nb']; ?></td>
                                                <td><?PHP echo $row['desc_pub']; ?></td>
                                                <td>
                                                    
                                                    
                                                    <form method="POST" action="supprimerPub.php">
                                                <button><img src="sup.png" class="consult"></button>
                                               <input type="hidden" value="<?PHP echo $row['id_pub']; ?>" name="id_pub">
                                                  </form>
                                                   <a href="modifierPub.php?id_pub=<?PHP echo $row['id_pub']; ?>">
