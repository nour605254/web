...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="promotion.css">
                <link rel="stylesheet" type="text/css" href="abonne.css">
...
<br /><br />
  <!--<div class="container" style="width:900px;">
   <h2 align="center">Statistique selon remise</h2>
   <h3 align="center"></h3>   
   <br /><br />
   <div id="chart"></div>
  </div>-->
...
$listeprom=$promoC->afficherpromo();
$legend=array();
$data=array();
foreach ($listeprom as $row) {
...
// Tableau des légendes
 array_push($legend,$row['num_promotion']);
 array_push($data,$row['nbr_achat']);
}
// On crée l'image
...
<!--khedma-->
                <script src="promotion.js"></script>
                 <script src="contolee.js" type="text/javascript"></script>
<!--wfe mail-->
