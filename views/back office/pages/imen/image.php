...
if (isset($_GET['num_promotion'])){
    ...
    foreach($result2 as $row){
        ...
        $image=$row['image'];
?>
<table style="border:solid; margin-top: 90px;">
    
<tr>
    

    <td style="border:solid; width: 450px; height: 300px;"><img src="<?php echo $row['image'] ;?>" alt="<?php echo $row['titre'] ;?>"style="height: 300px; width: 450px;" class="ima"></td>
    <td>
<table style="border:solid;">
<tr ><th style="text-align:center; font-size: 30px; " ><?php echo  $row['titre']?></th></tr>        
