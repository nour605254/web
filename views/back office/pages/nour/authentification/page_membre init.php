                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="http://localhost/git/web/views/back office/pages/nour/authentification/se_connecter.php" class="btn btn-default btn-flat">déconnexion</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                                       ...
                                       <thead class="thead-dark">
                                                    <tr>
                                                      ...
                                                      <th scope="col"> Action <br>
                                                        ...
                                                        <!--Bouton modifier-->
                                                    <a href="http://localhost/git/web/views/back office/pages/nour/client/affichermodifClient.php"><img src="src/icon.png" class="consult"></a>
                                                    <!--Bouton modifier-->

                                                    <!--Bouton supprimer-->
                                                  <a href="http://localhost/git/web/views/back office/pages/nour/client/affichersuppClient.php"> <img src="src/sup.png" class="consult"></a>
...
<!--fin champs action-->
                                                                                 ...
                                                                                 <?PHP
                                                                                    foreach($listeClients as $row){
                                                                                        ...
                                                                                        <th><form method="POST" action="http://localhost/git/web/views/back office/pages/nour/client/supprimerClient.php">
