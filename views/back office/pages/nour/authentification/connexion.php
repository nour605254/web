...
if ($vide==false) { 
         ...
         echo '<meta http-equiv="refresh" content="0;URL=http://localhost/tryyyy/views/back office/pages/nour/authentification/se_connecter.php">'; 
      } 
}	  
     ...
     ?> <a href="http://localhost/tryyyy/views/back office/pages/nour/authentification/se_connecter.php">Retour au formulaire</a>	 <?php 
}  
