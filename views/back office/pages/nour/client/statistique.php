...
{
 $chart_data .= "{ id:'".$row["id"]."', id:".$row["id"]."}, ";
}
...
<html>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="../authentification/se_connecter.php" class="btn btn-default btn-flat">déconnecter</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
  ...
  <div class="container" style="width:900px;">
   <h2 align="center">Statistique le nombre de clients </h2>
   <br /><br />
   <div id="chart"></div>
  </div>
 </body>
