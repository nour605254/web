                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="http://localhost/git/web/views/back office/pages/nour/authentification/se_connecter.php" class="btn btn-default btn-flat">
...
{ 
     ...
     echo $_SESSION['n'].'</b>  <b>'.$_SESSION['pr'];
     echo '<a href="./logout.php">Cliquer pour se déconnecter</a>';
      ...
      echo '<a href="http://localhost/git/web/views/front_office/nour/client/authentification/se_connecter.php">Cliquer pour se connecter</a>';
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>-</td>
                                                <td>
                                                    <a href="http://localhost/git/web/views/front_office/nour/client/afficherClient.php"><img src="src/icon.png" class="consult"></a>
                                                  <a href="http://localhost/git/web/views/front_office/nour/client/afficherClient.php"> <img src="src/sup.png" class="consult"></a>>
